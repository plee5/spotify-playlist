...
## Abstract
This is a Spotify client that allows users to search Spotify for songs and add tracks to their own playlist. This songs can also be played in-app. This app is deployed on netlify for everyone to use! You can find it here: 
...
- Add to playlist - add searched songs to playlist
